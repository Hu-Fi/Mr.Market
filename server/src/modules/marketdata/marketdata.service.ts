...
export class MarketdataService {
  ...
  private initializeExchange() {
    ...
    this.exchanges.set('bitfinex', new ccxt.pro.bitfinex());
    this.exchanges.set('mexc', new ccxt.pro.mexc());
    this.exchanges.set('binance', new ccxt.pro.binance());
    this.exchanges.set('okx', new ccxt.pro.okx());
    this.exchanges.set('gate', new ccxt.pro.gateio());
    this.exchanges.set('lbank', new ccxt.pro.lbank());
  }
