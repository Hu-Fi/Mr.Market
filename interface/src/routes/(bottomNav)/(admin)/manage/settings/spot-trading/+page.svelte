...
<div class="p-6 md:p-10 space-y-8 max-w-7xl mx-auto">
  ...
  >
    <div class="space-y-1">
      <h1 class="text-3xl font-bold tracking-tight">{$_("spot_trading")}</h1>
