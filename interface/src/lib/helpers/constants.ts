...
export const BALANCE_CURRENCY_USDUSDT_URL = "https://data.chain.link/api/query"
export const BALANCE_CURRENCY_USDFIAT_URL = "https://currencyzone.hsbc.com/currency-zone/v1/ccypairsrates"
