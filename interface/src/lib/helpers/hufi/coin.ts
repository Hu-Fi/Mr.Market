...
import type { OHLCVData, SupportedTimeFrame, TokenChartTimeFrame } from "$lib/types/hufi/exchanges";
...
export const fetchOHLCV = async (exchange: string, symbol: string, timeFrame: SupportedTimeFrame, limit: number = 2000): Promise<OHLCVData[]> => {
