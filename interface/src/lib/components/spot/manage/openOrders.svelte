<script lang="ts">
  ...
  $: os = [
    // {
    //   order_id: 'a22170a7-ec32-4718-80f7-c304959c3e42',
    //   first: "BTC",
    //   second: "USDT",
    //   price: 43576,
    //   exchange: "okx",
    ...
    .filter((item) => {
      switch ($orderFilterMode) {
        ...
        case 2:
          return item.type === "advanced_limit";
        case 3:
          return item.type === "tp" || item.type === "sp";
      }
    });
    ...
    <div class="flex flex-col space-y-4 items-center justify-center my-20">
      <svg
        ...
        /><path
          ...
          transform="translate(-276.18187 -133.91309)"
          fill="#6c63ff"
        /><circle cx="190.15351" cy="24.95465" r="20" fill="#6c63ff" /><circle
          cx="190.15351"
          cy="24.95465"
          r="12.66462"
          fill="#fff"
        ...
        /><path
          ...
          transform="translate(-276.18187 -133.91309)"
          fill="#6c63ff"
        /><circle cx="433.63626" cy="105.17383" r="20" fill="#6c63ff" /><circle
          cx="433.63626"
          cy="105.17383"
          r="12.18187"
          fill="#fff"
