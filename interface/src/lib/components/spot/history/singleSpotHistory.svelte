...
<button
  class="flex w-full flex-col space-y-3 border-b-slate-50 border-b py-4"
  on:click={() => {
    redirect(o.orderId);
  }}
>
  ...
  <div class="flex w-full justify-between">
    <div class="flex items-center space-x-1">
      <img
        src={findExchangeIconByIdentifier(o.exchangeName)}
        alt="icon"
        loading="lazy"
        class="w-4 h-4"
      />
    ...
    <div class="flex items-center">
      ...
      <svg
        ...
        class="w-4 h-4 text-xs opacity-80"
        fill="none"
        viewBox="0 0 24 24"
        stroke-width="1.5"
        stroke="currentColor"
  ...
  <div class="flex flex-col w-full space-y-3">
    ...
    <div class="flex items-center justify-between w-full">
      <div class="flex space-x-2">
        ...
        <div
          class={clsx(buy ? "bg-green-100" : "bg-red-100", "px-2 rounded-md")}
        >
          <span
            class={clsx(
    ...
    <div class="flex space-x-4 justify-between w-full">
      ...
      <div
        class={clsx(
          ...
          buy ? UpColorText : DownColorText,
        )}
        style={`--value:${100}; --size: 44px; --thickness: 2px;`}
        role="progressbar"
      >
