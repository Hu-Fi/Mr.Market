...
<div class="flex flex-col space-y-2 mx-4">
  ...
  <div class="flex items-center justify-between space-x-2 mx-2">
    ...
    <div class="join border rounded-lg items-center">
      <input inputmode="decimal" pattern="\d*\.?\d*" type="text" use:cleave={maskOption} data-testid="amount-input-0" bind:value={$createMMEasyAmounts[0]} class={clsx("input focus:border-none focus:outline-none w-32 join-item")} />
  ...
  <div class="flex items-center justify-between space-x-2 mx-2">
    ...
    <div class="join border rounded-lg items-center">
      <input inputmode="decimal" pattern="\d*\.?\d*" type="text" use:cleave={maskOption} data-testid="amount-input-1" bind:value={$createMMEasyAmounts[1]} class={clsx("input focus:border-none focus:outline-none w-32 join-item")} />
      <div class="join-item mr-2 w-12 text-end">
