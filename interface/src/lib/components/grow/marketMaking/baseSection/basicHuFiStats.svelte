<script>
  ...
  export let rewardsPool = 0;
  export let activeCampaigns = 0;
</script>

<button
  class="flex flex-col my-4 rounded-2xl border-slate-200 text-left bg-slate-50"
  on:click={() => {
    return goto("/market-making/hufi");
  }}
>
