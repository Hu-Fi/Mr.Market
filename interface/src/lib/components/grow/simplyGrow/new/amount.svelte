...
<div class="flex flex-col space-y-2 mx-4">
  ...
  <div class="flex items-center justify-between space-x-2 mx-2">
    <div class="flex space-x-2 items-center">
      <AssetIcon
        assetIcon={findCoinIconBySymbol($createSimplyGrowAsset?.symbol || "") ||
    ...
    <div class="join border rounded-lg items-center">
      <input
        ...
        bind:value={$createSimplyGrowAmount}
        class={clsx(
          "input focus:border-none focus:outline-none w-36 join-item pr-0 placeholder:text-base-content/40",
        )}
