...
<div class="flex flex-col space-y-2 mx-4">
  ...
  <div class="flex items-center justify-between space-x-2 mx-2">
    ...
    <div class="join border rounded-lg items-center">
      <input type="text" inputmode="decimal" use:cleave={maskOption} data-testid="amount-input-0" bind:value={$createArbAmount[0]} class={clsx("input focus:border-none focus:outline-none w-36 join-item", !$createArbAmount && "text-base-content/40")} placeholder={$_('enter_amount')} />
  ...
  <div class="flex items-center justify-between space-x-2 mx-2">
    ...
    <div class="join border rounded-lg items-center">
      <input type="text" inputmode="decimal" use:cleave={maskOption} data-testid="amount-input-1" bind:value={$createArbAmount[1]} class={clsx("input focus:border-none focus:outline-none w-36 join-item", !$createArbAmount && "text-base-content/40")} placeholder={$_('enter_amount')} />
      <div class="join-item mr-2 w-12 text-end">
