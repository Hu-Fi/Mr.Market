        ...
        <tr>
          ...
          <th>
            <div class="flex items-center gap-2">
              ...
              <div
                ...
                data-tip={$_("admin_exchange_supported_info")}
              >
                <svg
          ...
          <th>
            <div class="flex items-center gap-2">
              ...
              <div
                class="tooltip tooltip-bottom"
                data-tip={$_("admin_exchange_enable_info")}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
      ...
      <tbody>
        ...
        {#each exchanges as exchange}
          <tr>
            ...
            <td
              >{supportedExchanges.includes(exchange.exchange_id)
                ? "✅"
                : "❌"}</td
            >
            <td>
              ...
              >
                ...
                >
                  <span
                    class={clsx(
                      isUpdating === exchange.exchange_id &&
            ...
            <td>
              ...
              >
                <svg
                  ...
                  class={clsx(
                    "size-4",
                    isDeleting === exchange.exchange_id &&
