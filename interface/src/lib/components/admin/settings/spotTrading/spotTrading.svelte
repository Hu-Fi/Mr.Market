<script lang="ts">
  ...
  async function AddSpotTradingPair(pair: SpotdataTradingPair) {
      ...
      <tbody>
        ...
        {#each spotTradingPairs as pair}
          <tr>
            ...
            <td>
              <span class="text-xs select-text"> {pair.amount_siginifianct_figures} </span>
            </td>
            <td>
              <span class="text-xs select-text"> {pair.price_siginifianct_figures} </span>
            </td>
            <td>
