<script lang="ts">
  ...
  const cancel = () => {
    ...
    cancelOrderDone($cancelingOrder as any);
  };
</script>
...
>
  <div class="modal-box space-y-3 pt-0">
    ...
    <div class="flex items-center justify-center pb-4">
      <button
        class="btn btn-md h-[2.5rem] min-h-[2.5rem] rounded-full bg-slate-800 text-base-100"
        on:click={cancel}
      >
