...
>
  <div class="modal-box space-y-0 pt-0 pl-6">
      ...
      <div class="absolute left-[calc(50%-16px)] top-2">
        <div class="w-8 h-1 bg-slate-800/40 rounded-full">
          <form method="dialog" class="modal-backdrop">
            <button on:click={() => addMoreDialog.set(false)}>c</button
            >
          </form>
        </div>
      </div>
  ...
  <form method="dialog" class="modal-backdrop">
    <button on:click={() => addMoreDialog.set(false)}></button>
  </form>
</dialog>
