<script lang="ts">
  ...
  const getRouteString = (route: Array<{ exchange: string }>) => {
    let s = "";
...
<div class="flex flex-col mx-4 !mt-4 space-y-6">
  <div class="flex items-center justify-between">
    ...
    <button
      class="mx-2 flex flex-1 items-center justify-end"
  ...
  {#if openDetails}
    <div
      class="flex flex-col rounded-2xl border border-base-300 p-4 px-6 space-y-4 text-sm"
    >
